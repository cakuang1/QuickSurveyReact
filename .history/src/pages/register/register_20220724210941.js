        ...
        <div className='test'>
            <div className='box2'>
                ...
                <form className='loginform'>
                    <input id = "email" name = "firstname" placeholder='Enter your first name' onChange={handleChange} value = {inputs.email || ""}/>
                    <input id = "email" name = "email" placeholder='Enter your last name' onChange={handleChange} value = {inputs.email || ""}/>
