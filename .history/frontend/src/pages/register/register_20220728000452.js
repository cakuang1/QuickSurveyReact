...
import newuser from './registerapi';
    ...
    return (
        <div className='test'>
            <div className='box2'>
                ...
                <form className='loginform' onSubmit= {newuser(inputs.email,inputs.password)}>
                    ...
                    <input id = "passwordchecker" name = "passwordchecker" placeholder='Re-enter Password' onChange={handleChange} value = {inputs.retypedpassword || ""}/>
